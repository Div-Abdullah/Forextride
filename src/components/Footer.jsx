          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="centered-row gap-2 cursor-pointer hover:-translate-y-1 transition2">
                ...
                <h3 className="clash-display text-lg text-zinc-100 hover:text-indigo-400">
                  ForexTrade
                </h3>
              </div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/abdullah-al-sabahi-6a89021a2" className="w-6 h-6 hover:text-indigo-400 hover:-translate-y-1 transition2" target="_blank" rel="noopener noreferrer">
                  <FaInstagram />
                </a>
                <a href="https://www.linkedin.com/in/abdullah-al-sabahi-6a89021a2" className="w-6 h-6 hover:text-indigo-400 hover:-translate-y-1 transition2" target="_blank" rel="noopener noreferrer">
                  <FaFacebook />
